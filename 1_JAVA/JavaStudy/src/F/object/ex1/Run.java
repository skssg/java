...
public class Run {
	...
	/*
	 ...
	 5. 추상화 과정
		 ...
		 2) 그 객체들의 공통적인 속성(데이터), 기능들을 추출할 것
		 ...
		 ex) 학생 관리 프로그램
		 1) 학생관련 객체(이름1훈련생, 이름2훈련생, 이름3훈련생등등등...)
	 ...
	 6. 추상화한 객체를 프로그램에 적용시키기
	 	1."변수"만으로 프로그래밍을 한다.
	 		...
	 		학생1이라는 훈련생 객체 하나 만들기 -> String name1 = "학생1"; int age1 = 20; double height = 185.0;
	 		학생2이라는 훈련생 객체 하나 만들기 -> String name2 = "학생2"; int age2 = 19; double height2 = 193;
	 		
	 	2. 배열로 프로그래밍 한다면
	 		배열 : 하나의 자료형으로 여러개의 값들을 보관할 수 있음
	 		이름을 보관하는 배열 String[] name = {"학생1", "학생2"....}
	 	...
	 	-> 자바에서는 구조체개념을 좀 더 확장해서 클래스를 개념을 만들었다. \
