...
// InetAddress : 네트워크 정보(ip주소 관련)를 확인할수 있는 클래스
public class Run {
	public static void main(String[] args) {
		try {
			...
			System.out.println("내 IP주소 : " + localhost.getHostAddress()); // 호스의 IP주소를 반환
			
			System.out.println("=================================================================");
			
			InetAddress googleHost = InetAddress.getByName("www.gogle.com"); // 도메인명을 통해서 해당 호스트의 정보를 가져올 수 있다.
			
			System.out.println("google 서버명 : " + localhost.getHostName()); // google의 이름을 반환
			System.out.println("google IP주소 : " + localhost.getHostAddress()); // google의 IP주소를 반환
